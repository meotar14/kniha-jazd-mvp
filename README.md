...
- Počas bežiaceho mesiaca môže zostať `end_odometer_km` prázdne; systém ho dočasne uloží rovnako ako `start_odometer_km`, aby sa dali evidovať tankovania a plán priebežne dopĺňať
